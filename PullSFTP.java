...
//                    String[] sentences = fileItem.getName().split("\\_");
                    String remoteFile = "/"+pathFile.getString("remoteFile")+"/Achived/"+ new SimpleDateFormat("yyyyMMdd", Locale.US).format(new Date());
...
//					}
                    ...
                    try {
                        attrs = channelSftp.stat(remoteFile);
                    } catch (Exception e) {
	...
	public boolean mkdir(ChannelSftp channelSftp,String dir) {
	  try {
